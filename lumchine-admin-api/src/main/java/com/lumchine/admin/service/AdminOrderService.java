...
public class AdminOrderService {
    ...
    public Object list(Integer userId, String orderSn, List<Short> orderStatusArray,
        ...
        List<LumchineOrder> orderList = orderService.querySelective(userId, orderSn, orderStatusArray, page, limit,
                sort, order);
        return ResponseUtil.okList(orderList);
    }

    public Object detail(Integer id) {
        LumchineOrder order = orderService.findById(id);
        List<LumchineOrderGoods> orderGoods = orderGoodsService.queryByOid(id);
     ...
     * 2. 管理员登录lumchine管理后台点击退款操作进行订单状态修改和商品库存回库
     *
