...
public class AdminTopicController {
    ...
    public Object list(String title, String subtitle,
        ...
        List<LumchineTopic> topicList = topicService.querySelective(title, subtitle, page, limit, sort, order);
        return ResponseUtil.okList(topicList);
    }

    private Object validate(LumchineTopic topic) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody LumchineTopic topic) {
    ...
    public Object read(@NotNull Integer id) {
        ...
        List<LumchineGoods> goodsList = null;
    ...
    @PostMapping("/update")
    public Object update(@RequestBody LumchineTopic topic) {
        Object error = validate(topic);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody LumchineTopic topic) {
