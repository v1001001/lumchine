...
public class AdminCouponController {
    ...
    public Object list(String name, Short type, Short status,
        ...
        List<LumchineCoupon> couponList = couponService.querySelective(name, type, status, page, limit, sort, order);
    ...
    public Object listuser(Integer userId, Integer couponId, Short status,
                           ...
                           @Sort @RequestParam(defaultValue = "add_time") String sort,
                           @Order @RequestParam(defaultValue = "desc") String order) {
        List<LumchineCouponUser> couponList = couponUserService.queryList(userId, couponId, status, page,
                limit, sort, order);
        return ResponseUtil.okList(couponList);
    }

    private Object validate(LumchineCoupon coupon) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody LumchineCoupon coupon) {
    ...
    public Object read(@NotNull Integer id) {
        LumchineCoupon coupon = couponService.findById(id);
        return ResponseUtil.ok(coupon);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody LumchineCoupon coupon) {
        Object error = validate(coupon);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody LumchineCoupon coupon) {
