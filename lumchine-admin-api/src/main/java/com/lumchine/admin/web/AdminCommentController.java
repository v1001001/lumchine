...
public class AdminCommentController {
    ...
    public Object list(String userId, String valueId,
        ...
        List<LumchineComment> commentList = commentService.querySelective(userId, valueId, page, limit, sort, order);
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody LumchineComment comment) {
