...
import com.lumchine.admin.util.Permission;
import com.lumchine.admin.util.PermissionUtil;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.apache.shiro.authz.annotation.RequiresPermissions;
import com.lumchine.admin.annotation.RequiresPermissionsDesc;
import com.lumchine.admin.vo.PermVo;
...
import com.lumchine.db.service.LumchinePermissionService;
import com.lumchine.db.service.LumchineRoleService;
...
public class AdminRoleController {
    ...
    @Autowired
    private LumchineRoleService roleService;
    @Autowired
    private LumchinePermissionService permissionService;
    @Autowired
    ...
    public Object list(String name,
        ...
        List<LumchineRole> roleList = roleService.querySelective(name, page, limit, sort, order);
        return ResponseUtil.okList(roleList);
    }

    @GetMapping("/options")
    public Object options() {
        List<LumchineRole> roleList = roleService.queryAll();
    ...
    public Object read(@NotNull Integer id) {
        LumchineRole role = roleService.findById(id);
        return ResponseUtil.ok(role);
    }


    private Object validate(LumchineRole role) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody LumchineRole role) {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody LumchineRole role) {
        Object error = validate(role);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody LumchineRole role) {
        ...
        List<LumchineAdmin> adminList = adminService.all();
        for (LumchineAdmin admin : adminList) {
    ...
    private List<PermVo> getSystemPermissions() {
        final String basicPackage = "com.lumchine.admin";
    ...
    public Object updatePermissions(@RequestBody String body) {
        ...
        for (String permission : permissions) {
            LumchinePermission lumchinePermission = new LumchinePermission();
            lumchinePermission.setRoleId(roleId);
            lumchinePermission.setPermission(permission);
            permissionService.add(lumchinePermission);
        }
        return ResponseUtil.ok();
    }
