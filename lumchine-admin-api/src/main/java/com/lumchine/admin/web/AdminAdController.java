...
import com.lumchine.db.service.LumchineAdService;
...
public class AdminAdController {
    ...
    private Object validate(LumchineAd ad) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody LumchineAd ad) {
    ...
    public Object read(@NotNull Integer id) {
        LumchineAd ad = adService.findById(id);
        return ResponseUtil.ok(ad);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody LumchineAd ad) {
        Object error = validate(ad);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody LumchineAd ad) {
        Integer id = ad.getId();
        if (id == null) {
            return ResponseUtil.badArgument();
        }
