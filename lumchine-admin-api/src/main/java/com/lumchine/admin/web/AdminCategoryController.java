...
import com.lumchine.admin.vo.CategoryVo;
...
public class AdminCategoryController {
    ...
    public Object list() {
        ...
        List<LumchineCategory> categoryList = categoryService.queryByPid(0);
        for (LumchineCategory category : categoryList) {
            ...
            List<LumchineCategory> subCategoryList = categoryService.queryByPid(category.getId());
            for (LumchineCategory subCategory : subCategoryList) {
    ...
    private Object validate(LumchineCategory category) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody LumchineCategory category) {
    ...
    public Object read(@NotNull Integer id) {
        LumchineCategory category = categoryService.findById(id);
        return ResponseUtil.ok(category);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody LumchineCategory category) {
        Object error = validate(category);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody LumchineCategory category) {
