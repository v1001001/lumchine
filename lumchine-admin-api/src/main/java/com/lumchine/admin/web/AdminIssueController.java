...
import com.lumchine.db.service.LumchineIssueService;
...
public class AdminIssueController {
    ...
    @Autowired
    private LumchineIssueService issueService;
    ...
    public Object list(String question,
        ...
        List<LumchineIssue> issueList = issueService.querySelective(question, page, limit, sort, order);
        return ResponseUtil.okList(issueList);
    }

    private Object validate(LumchineIssue issue) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody LumchineIssue issue) {
    ...
    public Object read(@NotNull Integer id) {
        LumchineIssue issue = issueService.findById(id);
        return ResponseUtil.ok(issue);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody LumchineIssue issue) {
        Object error = validate(issue);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody LumchineIssue issue) {
