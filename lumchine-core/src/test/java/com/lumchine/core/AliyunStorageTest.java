...
import com.lumchine.core.storage.AliyunStorage;
...
public class AliyunStorageTest {
    ...
    public void test() throws IOException {
        ...
        aliyunStorage.store(new FileInputStream(test), testFile.length(), "image/png", "lumchine.png");
        Resource resource = aliyunStorage.loadAsResource("lumchine.png");
        String url = aliyunStorage.generateUrl("lumchine.png");
