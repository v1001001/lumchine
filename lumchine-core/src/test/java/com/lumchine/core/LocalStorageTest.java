...
import com.lumchine.core.storage.LocalStorage;
...
public class LocalStorageTest {
    ...
    public void test() throws IOException {
        ...
        localStorage.store(new FileInputStream(test), testFile.length(), "image/png", "lumchine.png");
        Resource resource = localStorage.loadAsResource("lumchine.png");
        String url = localStorage.generateUrl("lumchine.png");
