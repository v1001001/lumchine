...
import com.lumchine.core.storage.QiniuStorage;
...
public class QiniuStorageTest {
    ...
    public void test() throws IOException {
        ...
        qiniuStorage.store(new FileInputStream(test), testFile.length(), "image/png", "lumchine.png");
        Resource resource = qiniuStorage.loadAsResource("lumchine.png");
        String url = qiniuStorage.generateUrl("lumchine.png");
