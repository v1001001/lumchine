...
import com.lumchine.db.service.LumchineCommentService;
...
import com.lumchine.wx.service.UserInfoService;
...
public class WxCommentController {
    ...
    private Object validate(LumchineComment comment) {
     ...
     */
    @PostMapping("post")
    public Object post(@LoginUser Integer userId, @RequestBody LumchineComment comment) {
        if (userId == null) {
    ...
    public Object list(@NotNull Byte type,
        ...
        List<LumchineComment> commentList = commentService.query(type, valueId, showType, page, limit);

        List<Map<String, Object>> commentVoList = new ArrayList<>(commentList.size());
        for (LumchineComment comment : commentList) {
