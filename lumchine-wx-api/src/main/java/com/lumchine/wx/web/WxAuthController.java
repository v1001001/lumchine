...
import com.lumchine.db.service.CouponAssignService;
...
import com.lumchine.wx.dto.WxLoginInfo;
import com.lumchine.wx.service.CaptchaCodeManager;
import com.lumchine.wx.service.UserTokenManager;
import com.lumchine.wx.util.WxResponseCode;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import com.lumchine.core.util.CharUtil;
import com.lumchine.core.util.JacksonUtil;
import com.lumchine.core.util.RegexUtil;
...
public class WxAuthController {
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        List<LumchineUser> userList = userService.queryByUsername(username);
        LumchineUser user = null;
        if (userList.size() > 1) {
    ...
    public Object loginByWeixin(@RequestBody WxLoginInfo wxLoginInfo, HttpServletRequest request) {
        ...
        LumchineUser user = userService.queryByOid(openId);
        if (user == null) {
            user = new LumchineUser();
    ...
    public Object register(@RequestBody String body, HttpServletRequest request) {
        ...
        if (userList.size() == 1) {
            LumchineUser checkUser = userList.get(0);
    ...
    public Object reset(@RequestBody String body, HttpServletRequest request) {
        ...
        List<LumchineUser> userList = userService.queryByMobile(mobile);
        LumchineUser user = null;
        if (userList.size() > 1) {
            return ResponseUtil.serious();
        } else if (userList.size() == 0) {
