...
import com.lumchine.db.service.LumchineFeedbackService;
...
public class WxFeedbackController {
    ...
    @Autowired
    private LumchineFeedbackService feedbackService;
    @Autowired
    private LumchineUserService userService;

    private Object validate(LumchineFeedback feedback) {
     ...
     */
    @PostMapping("submit")
    public Object submit(@LoginUser Integer userId, @RequestBody LumchineFeedback feedback) {
        if (userId == null) {
