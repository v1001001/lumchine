<template>
  <div>
    ...
    <van-popup v-model="showKefu">
      <van-cell-group>
        <van-cell title="项目名称" value="蓝美奇" />
        <van-cell title="项目地址" value="Github"  url="https://github.com/v1001001/lumchine"/>
        <van-cell title="项目地址" value="Gitee"  url="https://gitee.com/v1001001/lumchine"/>
        <van-cell title="联系电话" value="021-xxxx-xxxx" />
        <van-cell title="联系QQ" value="312936102" />
